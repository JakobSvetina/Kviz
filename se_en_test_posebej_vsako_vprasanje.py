...
##from GLAVNI_MODEL import Napake
...
class prvo_vprasanje(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        total = Kviz.total
        Napake.__init__(self, parent, controller)
        ...
        odgovor1.pack()
        odgovor2 = tk.Button(self, command=lambda: [Napake.counter(), Napake.preveri_napake()], text='NE', font=("Helvetica", 16))
        odgovor2.pack()
        stevec_napak = tk.Label(self, text='Število napak = ', font=("Helvetica", 10))
        stevec_napak.pack()
